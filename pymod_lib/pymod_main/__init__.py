...
class PyMod(PyMod_main_menu_commands,
    ...
    def initialize_pymod_elements_information(self):
        ...
        # This will contain objects of the 'Modeling_session' class in order to build the 'Models'
        # submenu on the plugin's main menu.
        self.modeling_session_list = []

        ##### MODIFIED #####
        self.af_modeling_session_list = {}
        ##### END #####

        self.esm_modeling_session_list = []
        self.omegafold_modeling_session_list = []

        # Boltz
        self.performed_boltz_modeling_count = 0

        # BLAST analysis.
        self.blast_cluster_counter = 0

        # AF modeling
        self.af_cluster_counter = 0
    ...
    def initialize_colors(self):
        ...
        self.update_pymod_color_dict_with_dict(pmdt.af_color_dict)
        ...
        ##### MODIFIED #####
        self.update_pymod_color_dict_with_dict(pmdt.plddt_color_dict)
        ##### END #####
