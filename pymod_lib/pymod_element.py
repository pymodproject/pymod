...
from .pymod_seq.seq_headers import check_fetchable_pdb_from_header, check_fetchable_af_model_from_header
...
class PyMod_element:
    ...
    def __init__(self,
        ...
        # Check if a PDB file of an AlphaFold model can be fetched for this element from its name
        af_model_can_be_fetched = check_fetchable_af_model_from_header(self.original_header)

        if af_model_can_be_fetched == None:
            self.model_can_be_fetched = False
            self.model_id = None
            self.model_chain = None
        else:
            self.model_can_be_fetched = True
            self.model_id = self.original_header
            self.model_chain = ""
...
class _PyMod_sequence_element(PyMod_element):
    ...
    def initialize_additional_information(self):
        ...
        self._has_af_scores = False
        self._has_plddt_scores = False
        self._is_af_model = False
    ...
    def has_af_scores(self):
        return self._has_af_scores

    def has_plddt_scores(self):
        return self._has_plddt_scores
    ...
    def af_model_is_fetchable(self):
        return self.model_can_be_fetched
