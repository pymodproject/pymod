...
def check_fetchable_af_model_from_header(header):

    # TODO - AF REGEX - THE ONE USED NOW IS UNIPROT-ID REGEX ONLY

    match = re.search("[OPQ][0-9][A-Z0-9]{3}[0-9]|[A-NR-Z][0-9]([A-Z][A-Z0-9]{2}[0-9]){1,2}", header)
