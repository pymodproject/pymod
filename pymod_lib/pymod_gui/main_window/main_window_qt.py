...
class PyMod_main_window_qt(QtWidgets.QMainWindow,
    ...
    def color_selection(self, mode, target_selection, color_scheme, regular_color=None):
        ...
        for seq in elements_to_color:
            ...
            elif color_scheme == "af-scores":
                color_dict = self.color_element_by_af_scores(seq)
            ...
            ##### MODIFIED #####
                ...
                color_dict = self.color_element_by_plddt(seq)
            ##### END #####
    ...
    def color_element_by_af_scores(self, element, color_structure=True):
        """
        Color by AF scores.
        """
        element.color_by = "af-scores"
        return self.color_element(element, color_structure=color_structure)
    ...
    ##### MODIFIED #####
    def color_element_by_plddt(self, element, color_structure=True):
        """
        Color by plddt scores.
        """
        element.color_by = "plddt"
        return self.color_element(element, color_structure=color_structure)
    ##### END #####
    ...
    def assign_residue_coloring_method(self, element, color_target):
        ...
        elif element.color_by == "af-scores":
            if color_target == "sequence":
                return self.get_af_sequence_color
            elif color_target == "structure":
                return self.get_af_structure_color
        ...
        ##### MODIFIED #####
        elif element.color_by == "plddt":
            if color_target == "sequence":
                return self.get_plddt_sequence_color
            elif color_target == "structure":
                return self.get_plddt_structure_color
        ##### END #####
        else:
    ...
    # AF colors.
    def get_af_sequence_color(self, residue):
        return self.pymod.all_colors_dict_tkinter[self.form_af_color_name(residue)]

    def get_af_structure_color(self, residue):
        return self.form_af_color_name(residue)

    def form_af_color_name(self, residue):
        return "%s_%s" % (pmdt.pymol_af_color_name, residue.af_score)
    ...
    ##### MODIFIED #####
    # plddt colors.
    def get_plddt_sequence_color(self, residue):
        return self.pymod.all_colors_dict_tkinter[self.form_plddt_color_name(residue)]

    def get_plddt_structure_color(self, residue):
        return self.form_plddt_color_name(residue)

    def form_plddt_color_name(self, residue):
        return "%s_%s" % (pmdt.pymol_plddt_color_name, residue.plddt_score["interval"]) # output ex: pymod_plddt_2
    ##### END #####
