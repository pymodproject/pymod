    ...
    def mouseMoveEvent(self, event):
        ...
        if event.buttons() == QtCore.Qt.NoButton:
            ...
            if is_residue:
                ...
                ##### MODIFIED #####
                # Show the plddt score for the residue.
                elif self.parent_group.pymod_element.color_by == "plddt":
                    score = pymod_res.plddt_score["score"]
                    residue_information += " - plddt score: %s" % (score)
                ##### END #####
